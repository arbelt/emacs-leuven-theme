...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-header-content ((,class (:family ,sans-family :foreground "#3399CC"))))
   `(gnus-header-from ((,class (:family ,sans-family :foreground "blue"))))
   `(gnus-header-name ((,class ,mail-header-name)))
   `(gnus-header-newsgroups ((,class (:family ,sans-family :foreground "#3399CC"))))
   ...
   `(message-header-cc ((,class (:family ,sans-family :foreground "blue"))))
   `(message-header-other ((,class (:family ,sans-family :foreground "#3399CC"))))
   `(message-header-subject ((,class ,subject)))
   `(message-header-to ((,class (:family ,sans-family :foreground "blue"))))
   `(message-cited-text ((,class (:foreground "#5050B0"))))
   `(message-separator ((,class (:family ,sans-family :weight bold :foreground "red"))))
   `(message-header-newsgroups ((,class (:family ,sans-family :foreground "#3399CC"))))
   `(message-header-xheader ((,class (:family ,sans-family :foreground "#3399CC"))))
   ...
   `(custom-face-tag ((,class (:family ,sans-family :height 1.2 :weight bold))))
   `(custom-group-tag ((,class (:height 1.2 :weight bold :foreground "blue1"))))
   `(custom-group-tag-1 ((,class (:family ,sans-family :height 1.2 :weight bold :foreground "red1"))))
   ...
   `(custom-variable-tag ((,class (:family ,sans-family :height 1.2 :weight bold :foreground "blue1"))))
   ...
   `(font-latex-sectioning-1-face ((,class (:family ,sans-family :height 1.1 :weight bold :foreground "cornflower blue"))))
   ...
   `(helm-source-header ((,class (:family ,sans-family :height 1.3 :weight bold :foreground "white" :background "#2F69BF"))))
   ...
   `(info-menu-header ((,class (:family ,sans-family :height 1.6 :weight bold :underline t :foreground "#00CC00")))) ;; menu titles (headers) -- major topics
   ...
   `(magit-diff-file-header ((,class (:family ,sans-family :height 1.1 :weight bold :foreground "#4183C4"))))
   ...
   `(magit-section-title ((,class (:family ,sans-family :height 1.1 :weight bold :foreground "cornflower blue"))))
   ...
   `(org-agenda-date ((,class (:height 1.1 :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (:height 1.1 :weight bold :foreground "#4F4A3D" :background "#FFFABE"))))
   `(org-agenda-date-weekend ((,class (:height 1.1 :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-agenda-structure ((,class (:height 1.1 :weight bold :box (:line-width 1 :color "#999999") :foreground "#666666" :background "#CCCCCC"))))
   ...
   `(org-document-title ((,class (:family ,sans-family :height 1.1 :weight bold :foreground "black"))))
   ...
   `(persp-selected-face ((,class (:weight bold :foreground "white"))))
   ...
   ;; workgroup
   `(wg-mode-line-face ((,class (:foreground "chartreuse" :weight bold))))
   `(wg-divider-face ((,class (:foreground "Tomato"))))
   `(wg-brace-face ((,class (:foreground "OrangeRed"))))
   `(wg-current-workgroup-face ((,class (:foreground "blue" :weight bold))))
   `(wg-previous-workgroup-face ((,class (:foreground "DarkMagenta"))))
   `(wg-other-workgroup-face ((,class (:foreground "DarkSlateGray"))))
   `(wg-message-face ((,class (:foreground "ForestGreen"))))
   `(wg-frame-face ((,class (:foreground "Firebrick"))))
   `(wg-filename-face ((,class (:foreground "DarkCyan"))))
   `(wg-command-face ((,class (:foreground "ForestGreen"))))
