...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-header-content ((,class (:family ,sans-family :foreground "#786FB4"))))
   ...
   `(custom-face-tag ((,class (:family ,sans-family :weight bold :height 1.2))))
   `(custom-group-tag ((,class (:bold t :foreground "blue1" :weight bold :height 1.2))))
   `(custom-group-tag-1 ((,class (:bold t :family ,sans-family :foreground "red1" :weight bold :height 1.2))))
   ...
   `(custom-variable-tag ((,class (:bold t :family ,sans-family :foreground "blue1" :weight bold :height 1.2))))
   ...
   `(font-latex-sectioning-1-face ((,class (:family ,sans-family :height 2.7 :weight bold :foreground "cornflower blue"))))
   ...
   `(helm-source-header ((,class (:family ,sans-family :height 1.3 :weight bold :foreground "white" :background "#666699"))))
